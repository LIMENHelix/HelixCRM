...
export interface Contact {
  ...
  status: string; tags: string[]; tcpaConsent: boolean;
  createdAt: string; lastContacted: string | null; notes: string;
}
export interface Campaign {
  id: string; name: string; subject: string; body: string;
  status: string; recipients: string[]; sentCount: number;
  openCount: number; replyCount: number; optOutCount: number;
  sentAt: string | null; createdAt: string;
}
export interface EmailThread {
  id: string; contactId: string; contactName: string; contactEmail: string;
  subject: string; lastMessage: string; direction: string;
  status: string; aiClassification: string | null; aiDraftReply: string | null;
  messages: any[]; updatedAt: string;
}
...
export const Icons = {
  ...
  Inbox: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></svg>,
  ...
  Sparkle: () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>,
